...
The document-type branch of [`writing-for-agents`](SKILL.md) for a child task, review prompt, or other one-shot agent prompt. Ticket dispatch already fills this in `/implement-ticket`; use this file for ad-hoc tasks.
